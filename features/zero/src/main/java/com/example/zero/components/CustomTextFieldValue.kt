...
fun CustomTextFieldValue(
    ...
    textStyle: TextStyle = MaterialTheme.typography.primaryParagraph(),
    ...
    textFieldColor: Color = AppTheme.colors.surfaceVariant,
    shape: Shape = RectangleShape
) {
    BasicTextField(
        modifier = modifier.fillMaxWidth().background(textFieldColor, shape),
        value = value,
